...
class ReportDailyScreen extends ConsumerStatefulWidget {
  const ReportDailyScreen({super.key});

  @override
  ConsumerState<ReportDailyScreen> createState() => _ReportDailyScreenState();
}

class _ReportDailyScreenState extends ConsumerState<ReportDailyScreen> {
  late final ReportDailyController _controller;
  DateTime _day = DateTime.now();

  @override
  void initState() {
    super.initState();
    // Lấy repo từ Riverpod thay vì AppScope
    final repo = ref.read(transactionRepoProvider);
    _controller = ReportDailyController(repo);
    _controller.load(_day);
  }
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'Ngày ${_day.day}/${_day.month}/${_day.year}',
