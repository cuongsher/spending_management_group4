...
import 'report_weekly_controller.dart';

class ReportWeeklyScreen extends StatefulWidget {
  const ReportWeeklyScreen({super.key});

  @override
  State<ReportWeeklyScreen> createState() => _ReportWeeklyScreenState();
}

class _ReportWeeklyScreenState extends State<ReportWeeklyScreen> {
  ...
  void initState() {
    super.initState();
    _controller = ReportWeeklyController(AppScope.transactionRepo);
