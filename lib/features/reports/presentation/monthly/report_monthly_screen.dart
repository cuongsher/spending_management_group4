...
import 'report_monthly_controller.dart';

class ReportMonthlyScreen extends StatefulWidget {
  const ReportMonthlyScreen({super.key});

  @override
  State<ReportMonthlyScreen> createState() => _ReportMonthlyScreenState();
}

class _ReportMonthlyScreenState extends State<ReportMonthlyScreen> {
  ...
  void initState() {
    super.initState();
    _controller = ReportMonthlyController(AppScope.transactionRepo);
