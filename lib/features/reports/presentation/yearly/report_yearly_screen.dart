...
import 'report_yearly_controller.dart';

class ReportYearlyScreen extends StatefulWidget {
  const ReportYearlyScreen({super.key});

  @override
  State<ReportYearlyScreen> createState() => _ReportYearlyScreenState();
}

class _ReportYearlyScreenState extends State<ReportYearlyScreen> {
  ...
  void initState() {
    super.initState();
    _controller = ReportYearlyController(AppScope.transactionRepo);
